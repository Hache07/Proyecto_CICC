...
<body>
    ...
    <div class="seleccion container-fluid">
        ...
        <div class="row row-ini">
            ...
            <a href="medicina.php" class="col-md-2 facu"><div><i class="fas fa-user"></i> Medicina</div></a>
            <a href="derecho.php" class="col-md-2 facu"><div><i class="fas fa-user"></i> Derecho</div></a>
        </div>
    </div>

    ...
    <div class="navbar sticky-top">
        <nav class="navbar-expand-lg navbar-dark container-fluid row">
            <div class="logo col-md-3 col-sm-12" >
                <a href="admin_area.php"><img src="uploads/logo.png" alt="logo udabol" style="width: 80%; margin-left:30px"></a>
            </div>
            ...
            <div class="link-cerrar col-md-3 col-sm-12">
                <a class="nav-link float-right cerrar" href="cerrar.php">Cerrar sesion</a>
            </div> 
        </nav>
    </div>

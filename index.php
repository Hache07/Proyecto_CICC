    ...
    <div class="container conf-container">
        <div class="informacion row">
            ...
            <div class="col-md-4 col-sm-12 count">
                ...
                <p class="number" id="number-e"></p>
                <p>Estudiantes</p>
            </div>
        </div>
        <h3 class="unico">Descubre las mejores conferencias 2018</h3>
            ...
            <ul class="lista-precios clearfix">
                <li>
                    <div class="tabla-precio">
                        ...
                        <p class="numero">$30</p>
                        <ul>
                            <li><i class="fas fa-check"></i> Refrigerio gratis</li>
                            <li><i class="fas fa-check"></i> Todas las conferencias</li>
                            <li><i class="fas fa-check"></i> Material de apoyo</li>
                        </ul>
                        <a href="#" class="button hollow">Pagar</a>
                    </div>
                </li>
                <li>
                    <div class="tabla-precio">
